...
char commandsNames[][MAX_ARG_LEN]={"test_processes","test_prio","test_sync","nice","unblockPid","blockPid","ps","getPid","kill","time","help","inforeg","chess","printmem","divZero","invalidOPCode","clear","echo","UWU"};
void  (* run[])(char args[MAX_ARGS][MAX_ARG_LEN]) = {ProcessTester,prioTester,semTester,niceS,unblockPid,blockPid,ps,getPid,killS,time,help,inforeg,chessS,printmem,divZero,invalidOPCode,clear,echo,uwu};
