...
void  (* run[])(char args[MAX_ARGS][MAX_ARG_LEN]) = {semTester,test,nice,unblockPid,blockPid,listAllProcess,getPid,kill,time,help,inforeg,chess,printmem,divZero,invalidOPCode,clear,echo,uwu};
